...
$(document).ready(function() {
    $(".section-testimonials [data-section]").on("click", function(el) {

        let sectionID = $(this).attr('data-section');
        $(".section-testimonials .col-md-2 [data-section]").each(function() {
            $(this).addClass('opacity-75');
        });
        $(this).removeClass("opacity-75");

        $(".section-testimonials .testimonial").each(function(e) {
            $(this).removeClass("active-section");
        })
        $(".section-testimonials .testimonial[data-section=" + sectionID + "]").addClass("active-section");
    })
});
